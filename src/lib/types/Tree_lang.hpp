#ifndef TYPE_TREE_LANG_TYPE_HPP_INCLUDED
#define TYPE_TREE_LANG_TYPE_HPP_INCLUDED
...
Return_code   print_node_value                (FILE* file, Node* node);
const char*  _op_code_to_str                  (Op_code op_code);
